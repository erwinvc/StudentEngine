...
bool ImGui::ImageButton(unsigned int user_texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, int frame_padding, const ImVec4& bg_col, const ImVec4& tint_col) {
	return ImageButton((void*)(uint64_t)user_texture_id, size, uv0, uv1, frame_padding, bg_col, tint_col);
}
